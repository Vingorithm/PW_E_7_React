  ...
  return (
    <div className="container py-4">
      ...
      <div className="text-center mb-4">
        ...
        <br />
        <p class="text-muted">Discover our upcoming vehicle lineup at Atma AutoBid, featuring the latest and most anticipated
            models ready to be auctioned.
            Stay ahead and explore the next wave of high-quality vehicles before anyone else.
        </p>
      </div>
