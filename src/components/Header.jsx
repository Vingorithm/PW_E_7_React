            ...
            <div className="navbar">
                ...
                <div className="container-loginz">
                    {isLoggedIn ? (
                        <div className="user-info" onClick={handleDropdownToggle}>
                            ...
                            {dropdownVisible && (
                                <div className="dropdown">
                                    ...
                                    <a href="/" className="dropdown-item logout" id="logoutButton" onClick={handleLogout}>
                        ...
                        <a className="loginlink button-nav" href="/login" style={{ display: 'flex' }}>Login / Register</a>
                    )}
                </div>
            </div>
        </header>
